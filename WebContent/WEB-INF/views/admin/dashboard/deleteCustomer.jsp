...
<body>
	...
	<div style="position: relative; top: -550px">
		...
		<div
			...
			<div>
				<h3 class="h2">Delete Customer</h3>
			</div>
		</div>

		<div class="form-submit" style="display: flex;">
			<form:form action="{id}.htm" modelAttribute="userMess">
				<table>
					<tr>
					...
					<tr>
						<td><label>User's Mail</label></td>
						<td><form:input path="userMail" disabled="true" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><form:input path="phone" disabled="true" /></td>
					</tr>
					<tr>
						<td><label>Message</label></td>
						<td><form:input path="message" disabled="true" /></td>
					</tr>
					...
					<tr>
						...
						<td><a
							href="/WeatherForecast_Project/dashboard/data-customer/1.htm"
